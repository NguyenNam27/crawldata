                            ...
                            <div class="box-body">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input value="{{$edit_ProductOriginal->code_product_original}}" class="form-control" type="text" name="code_product_original">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1"> Name </label>
                                        <input value="{{$edit_ProductOriginal->name_product_original}}" data-validation="required"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="{{$edit_ProductOriginal->price_product_original}}" class="form-control" type="text" name="price_product_original">


                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Link</label>
                                        <input value="{{$edit_ProductOriginal->url_product_original}}" class="form-control" type="text" name="url_product_original">
